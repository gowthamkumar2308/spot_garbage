...
import { ArrowRight, BellRing, CheckCircle2, MapPin, ShieldCheck, Upload, Workflow, Zap } from "lucide-react";
        ...
        <div className="container py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <ul className="mt-6 grid gap-2 text-sm text-muted-foreground">
              <li className="inline-flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-primary"/> ML-based verification</li>
              <li className="inline-flex items-center gap-2"><MapPin className="h-4 w-4 text-primary"/> Geotagged reports</li>
              <li className="inline-flex items-center gap-2"><BellRing className="h-4 w-4 text-primary"/> Instant notifications</li>
            </ul>
          </div>
            ...
            <div className="rounded-xl border bg-card p-4 shadow-sm">
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-md bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-4 border">
                  <div className="font-medium mb-1 inline-flex items-center gap-2"><Upload className="h-4 w-4"/> Upload</div>
                  <p className="text-muted-foreground">Post geotagged images of garbage.</p>
                </div>
                <div className="rounded-md bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-4 border">
                  <div className="font-medium mb-1 inline-flex items-center gap-2"><Zap className="h-4 w-4"/> Verify</div>
                  <p className="text-muted-foreground">ML detects waste automatically.</p>
                </div>
                <div className="rounded-md bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-4 border">
                  <div className="font-medium mb-1 inline-flex items-center gap-2"><Workflow className="h-4 w-4"/> Sort</div>
                  <p className="text-muted-foreground">Filter by toxicity and type.</p>
                </div>
                <div className="rounded-md bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-4 border">
      ...
      <section>
        <div className="container py-16">
          ...
          <ol className="grid md:grid-cols-3 gap-6">
            {[
              { t: "User Upload", d: "Click or upload a photo and submit location." },
